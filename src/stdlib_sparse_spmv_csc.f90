...
contains
    ...
    module subroutine spmv_csc_1d_sp(matrix,vec_x,vec_y,alpha,beta,op)
        ...
        call spmv_csc_sub_1d_sp(matrix%data,matrix%colptr,matrix%row,matrix%nnz,matrix%nrows,matrix%ncols,matrix%storage, &
    ...
    module subroutine spmv_csc_2d_sp(matrix,vec_x,vec_y,alpha,beta,op)
        ...
        call spmv_csc_sub_2d_sp(matrix%data,matrix%colptr,matrix%row,matrix%nnz,matrix%nrows,matrix%ncols,matrix%storage, &
            vec_x,vec_y,alpha,beta,op)
    ...
    module subroutine spmv_csc_1d_dp(matrix,vec_x,vec_y,alpha,beta,op)
        ...
        call spmv_csc_sub_1d_dp(matrix%data,matrix%colptr,matrix%row,matrix%nnz,matrix%nrows,matrix%ncols,matrix%storage, &
            vec_x,vec_y,alpha,beta,op)
    ...
    module subroutine spmv_csc_2d_dp(matrix,vec_x,vec_y,alpha,beta,op)
        ...
        call spmv_csc_sub_2d_dp(matrix%data,matrix%colptr,matrix%row,matrix%nnz,matrix%nrows,matrix%ncols,matrix%storage, &
            vec_x,vec_y,alpha,beta,op)
    ...
    module subroutine spmv_csc_1d_csp(matrix,vec_x,vec_y,alpha,beta,op)
        ...
        call spmv_csc_sub_1d_csp(matrix%data,matrix%colptr,matrix%row,matrix%nnz,matrix%nrows,matrix%ncols,matrix%storage, &
            vec_x,vec_y,alpha,beta,op)
    ...
    module subroutine spmv_csc_2d_csp(matrix,vec_x,vec_y,alpha,beta,op)
        ...
        call spmv_csc_sub_2d_csp(matrix%data,matrix%colptr,matrix%row,matrix%nnz,matrix%nrows,matrix%ncols,matrix%storage, &
            vec_x,vec_y,alpha,beta,op)
    ...
    module subroutine spmv_csc_1d_cdp(matrix,vec_x,vec_y,alpha,beta,op)
        ...
        call spmv_csc_sub_1d_cdp(matrix%data,matrix%colptr,matrix%row,matrix%nnz,matrix%nrows,matrix%ncols,matrix%storage, &
            vec_x,vec_y,alpha,beta,op)
    ...
    module subroutine spmv_csc_2d_cdp(matrix,vec_x,vec_y,alpha,beta,op)
        ...
        call spmv_csc_sub_2d_cdp(matrix%data,matrix%colptr,matrix%row,matrix%nnz,matrix%nrows,matrix%ncols,matrix%storage, &
            vec_x,vec_y,alpha,beta,op)
